...
typedef void * (*process_cb_t)(void * arg);
...
*/
threadpool_t * threadpool_create(int max_thread_num);
...
*   void
*/
void threadpool_destroy(threadpool_t * handler);
...
*   void
*/
void threadpool_put(threadpool_t * handler, process_cb_t cb, void * arg);
